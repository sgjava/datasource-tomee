 ...
 *
 * As a work around I use the container to look up the DataSource. The trick is
 * using System properties instead of container properties to get the DataSource
 * created.
 *
 * @author sgoldsmith
 * @version 1.0.0
 * @since 1.0.0
 */
public class DataSourceLookupTest1 {

    /**
     * Logger.
     */
    private static final Logger log = Logger.getLogger(
            DataSourceLookupTest1.class.
            getName());
    /**
     * EJB container.
     */
